...
class Node extends EventEmitter {
    ...
    tell(/*whoWhat, ...args, callback*/) {
      ...
      // parse the arguments special array into a standard array
        ...
        var msg = new Message(enums.TELL, destination);
    ...
    leave(force) {
        ...
        var msg = new Message(enums.LEAVE);
    ...
    _onData(rawData) {
        ...
        try {
            var events = rawData.toString().split(enums.EOL);
    ...
    ***********************************************************/
    ...
    _onACKMessage(message) {
        ...
        var handler = this._callbacks[mid] || noop;
